        ...
        <BenefitsList.Item theme='light-gray' icon={(<Key className="w-8 sm:w-16 h-auto" />)}>
          <>
            { (props.contract.name === 'Crédit Ballon') && (
              <>
                <span slot="text">
                  <span className="font-bold">Changez de BMW sans contrainte</span> : si vous décidez de restituer
                  votre véhicule, BMW Financial Services le reprend, vous ne vous
            ...
            { (props.contract.name === 'LLD' || props.contract.name === 'PassLease LLD') && (
              <span slot="text">
                ...
                Changez de BMW sans contrainte : à la fin de votre contrat,
                BMW Financial Services reprend votre véhicule, vous ne vous
                souciez pas de la revente.
              </span>
            )}
            { props.contract.name === 'LOA' && (
