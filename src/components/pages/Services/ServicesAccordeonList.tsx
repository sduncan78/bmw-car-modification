...
const Cocarde = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38.34 52.906" {...props}>
    <path fill="currentColor" d="M15.527 0a2.153 2.153 0 0 0-.615.077c-1.529.473-2.125 2.929-3.43 3.852-1.14.81-3.178.679-4.316 1.5a2.006 2.006 0 0 0-.424.424c-.953 1.285-.031 3.644-.539 5.164s-2.645 2.785-2.658 4.393 2.136 2.973 2.619 4.509-.508 3.848.424 5.163 3.451 1.154 4.74 2.119 1.832 3.41 3.351 3.931 3.448-1.066 5.049-1.04 3.481 1.667 5.01 1.194 2.164-2.891 3.467-3.816 3.787-.679 4.74-1.964.031-3.643.539-5.164 2.684-2.824 2.7-4.431-2.175-2.9-2.658-4.432.508-3.848-.424-5.163-3.451-1.192-4.74-2.158S26.53.71 25.011.189s-3.446 1.143-5.049 1.117c-1.4-.021-3.02-1.306-4.432-1.309Zm4.317 8.824a6.782 6.782 0 1 1-6.782 6.782 6.781 6.781 0 0 1 6.782-6.782ZM7.359 27.936 0 41.269l8.592.232 3.931 8.284 5.356-9.556-1.811-6.859a3.425 3.425 0 0 1-2.158.116c-1.75-.6-2.408-3.4-3.893-4.509a8.107 8.107 0 0 0-2.658-1.04Zm24.391.5a6.628 6.628 0 0 0-2.311.81c-1.5 1.064-2.172 3.888-3.931 4.431s-3.973-1.4-5.819-1.425a6.114 6.114 0 0 0-2.2.578l5.745 20.076 5.664-7.09 9.442 2.852-6.59-20.231Z"/>
  </svg>
)
...
const ServicesAccordeonList = (): JSX.Element => (
  <AccordeonList>
    ...
    >
      <p>Vous accédez à des opérations de maintenance à un tarif fixe.</p>
    </AccordeonList.Item>
    <AccordeonList.Item
      title="Cessibilité"
      icon={(<Switch className="w-4 sm:w-8 h-auto" />)}
    >
      <p>Votre contrat est automatiquement transféré au nouveau propriétaire du véhicule augmentant ainsi sa valeur.</p>
    </AccordeonList.Item>
    <AccordeonList.Item
      title="Qualité"
      icon={(<Cocarde className="w-4 sm:w-8 h-auto" />)}
    >
      <p>Faites entretenir votre véhicule par des techniciens parfaitement formés qui utilisent des pièces d’Origine BMW.</p>
    </AccordeonList.Item>
  </AccordeonList>
)
